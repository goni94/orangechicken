...
public class SendController {
    ...
    @ResponseBody
    public String saveBankName(@RequestBody Map<String, String> payload, HttpSession session) {
        String bankName = payload.get("bank");
    ...
    public String deposit(@RequestParam("amount") double amount, 
        ...
        int accountRE = Integer.parseInt(rc);
        ...
        int accountNumber = Integer.parseInt(aNum);
